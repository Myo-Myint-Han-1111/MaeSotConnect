...
const CourseInfoDisplay: React.FC<CourseInfoDisplayProps> = ({
  ...
  return (
    <div className={containerClass}>
      ...
      {/* Apply By Date (Application Deadline) - Show estimated date badge based on preferences */}
      {applyByDate && (
        <div className={itemClass} style={{ color: grayColor }}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {/* Show estimated date badge only if preferences allow it for apply by date - removed calendar icon */}
